...
| [[systems/packs\|packs]] | Skill packs: core stays generic; domain skill sets mount as pinned pack submodules from a curated registry ([[systems/packs.yaml\|packs.yaml]]); pack conformance and inter-pack dependencies ([[systems/pack.schema.json\|pack.schema.json]] is the machine-readable manifest contract) |
