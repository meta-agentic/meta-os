...
| [[systems/repo-docs\|repo-docs]] | Entry READMEs as a distributed knowledge base: the one-home rule, graduated onboarding structure, one runnable example per procedure, public/private link boundary |
...
| [[systems/packs\|packs]] | Skill packs: core stays generic; domain skill sets mount as pinned pack submodules from a curated registry ([[systems/packs.yaml\|packs.yaml]]); the pack/discipline vocabulary and what a discipline adds to a plain skill (rigor standard + ledger); pack conformance and inter-pack dependencies ([[systems/pack.schema.json\|pack.schema.json]] is the machine-readable manifest contract); the improvement loop by which a discipline evolves |
